...
export async function generateArticle(
  ...
  let article = articleFromDraft(await callOpenAI(
    "draft",
    pack,
    "Redija em português do Brasil usando somente as evidências fornecidas. Não invente fatos. Título, metaDescription, excerpt, headings e corpo devem restringir conclusões a este experimento, sem regras gerais ou alegações de necessidade. Cada frase factual ou inferência deve ser sustentada pelos sourceIds do próprio bloco. O campo privacy classifica o pacote editorial e não comprova características dos documentos analisados. Não transforme verificações específicas em garantia geral de integridade ou ausência de inconsistências. Não exponha hashes ou identificadores internos. Retorne apenas os campos redacionais do schema.",
  ...
  if (issues.length === 0) {
    const firstAudit = audit(await callOpenAI(
      ...
      "Audite título, metaDescription, excerpt, headings e corpo quanto a escopo, factualidade, autoria, privacidade e suporte. Todas as conclusões devem ficar explicitamente restritas a este experimento, sem regras gerais ou alegações de necessidade. O campo privacy classifica o pacote editorial e não comprova características dos documentos analisados. Reprove generalizações de verificações específicas, qualquer fato novo e qualquer bloco cujos sourceIds não sustentem todas as suas frases.",
  ...
  article = articleFromDraft(await callOpenAI(
    ...
    "Corrija somente os problemas indicados, sem criar fatos, fontes ou conclusões. Título, metaDescription, excerpt, headings e corpo devem restringir conclusões a este experimento, sem regras gerais ou alegações de necessidade. Cada frase factual ou inferência deve ser sustentada pelos sourceIds do bloco. O campo privacy classifica o pacote editorial e não comprova características dos documentos analisados. Não transforme verificações específicas em garantia geral de integridade ou ausência de inconsistências. Não exponha hashes ou identificadores internos. Retorne apenas os campos redacionais do schema.",
  ...
  const finalAudit = audit(await callOpenAI(
    "final-audit",
    { evidence: pack, article },
    "Faça a auditoria final de título, metaDescription, excerpt, headings e corpo. Todas as conclusões devem ficar explicitamente restritas a este experimento, sem regras gerais ou alegações de necessidade. O campo privacy classifica o pacote editorial e não comprova características dos documentos analisados. Reprove generalizações de verificações específicas, qualquer fato novo, problema de autoria ou privacidade e qualquer bloco cujos sourceIds não sustentem todas as suas frases.",
